...
func FetchBestState(dbTx database.Tx) (*chainhash.Hash, uint32, error) {
	data, err := ticketdb.DbFetchBestState(dbTx)
	if err != nil {
		return nil, 0, err
	}
	return &data.Hash, data.Height, err
}