...
import (
	...
	"github.com/decred/hcData/v4/netparams"
...
// netName returns the name used when referring to a decred network. TestNet2
// correctly returns "testnet2", but not TestNet2. This function may be removed
...
func netName(chainParams *netparams.Params) string {
	...
	case wire.TestNet2, wire.MainNet, wire.SimNet:
	default:
